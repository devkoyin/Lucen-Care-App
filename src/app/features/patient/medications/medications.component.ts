...
export class MedicationsComponent implements OnInit {
  ...
  readonly refillAlerts: { name: string; pillsLeft: number; refillDate: string; urgency: RefillUrgency }[] = [
  ...
  readonly medications = signal<Medication[]>([
    {
      ...
      pillsRemaining: 24,
      pillsTotal: 60,
      refillDate: '18 Jun 2026',
      refillDateISO: '2026-06-18',
      refillUrgency: 'ok',
    },
    {
      id: 'lisinopril',
      ...
      pillsRemaining: 8,
      pillsTotal: 30,
      refillDate: '12 Jun 2026',
      refillDateISO: '2026-06-12',
    ...
    },
    {
      ...
      pillsRemaining: 30,
      pillsTotal: 30,
      refillDate: '4 Jul 2026',
      refillDateISO: '2026-07-04',
      refillUrgency: 'ok',
    },
    {
      id: 'atorvastatin',
      ...
      pillsRemaining: 14,
      pillsTotal: 30,
      refillDate: '25 Jun 2026',
      refillDateISO: '2026-06-25',
  ...
  readonly activeMedCount = computed(() => this.medications().length);

  readonly stats = computed(() => [
    { value: String(this.activeMedCount()), label: 'Active Meds',     icon: '💊' },
    { value: '4',                           label: 'Taken Today',      icon: '✅' },
    { value: '2',                           label: 'Due Today',        icon: '⏱' },
