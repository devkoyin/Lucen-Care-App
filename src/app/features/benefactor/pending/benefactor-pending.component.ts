...
@Component({
  selector: 'lc-benefactor-pending',
  standalone: true,
  template: `
...
export class BenefactorPendingComponent {
  ...
  get description(): string {
    ...
    return 'Our team is reviewing your identity document. You will be able to access communities once your Verified Benefactor badge is granted.';
  }
}
